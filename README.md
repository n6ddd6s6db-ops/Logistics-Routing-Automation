...
## Live Demo
*(Note: If you want to try it yourself, you can make a copy of the public Google Sheet template here: [Public Google Sheet Template]((https://docs.google.com/spreadsheets/d/1snmRcfiafsXOM53xA_qjvuO9FCXmlXXfyWuR2qV69u4/edit?usp=sharing)))*
